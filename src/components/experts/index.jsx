...
const experts = [
  ...
  },
  {
    ...
    description:
      "Biomedical engineer. Ex Accenture, Ex Wipro.",
    image: doc2,
  },
  // {
  //   id: 3,
...
const Experts = () => {
  ...
  >
    {experts.map((doc) => (
      <div
        key={doc.id}
        className="bg-white p-4 rounded-[20px] max-w-md shadow-lg drop-shadow-[0_4px_8px_rgba(221,124,254,0.4)]"
      >
        <img
          src={doc.image}
          alt={doc.name}
        ...
        <p className="text-[18px] mt-4 font-[600] text-[#24292E]">
          Speciality:{" "}
          <span className="font-[500] text-primary-500">{doc.speciality}</span>
        </p>
